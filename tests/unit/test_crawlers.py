...
from lead_crawler.crawlers.wko import BUNDESLAENDER, PLZ_BUNDESLAND, WKOCrawler
...
class TestWKOCrawler:
    ...
    def test_parse_item_no_name(self):
        ...
        data = {"street": "Teststraße 1", "plz": "2351"}
    ...
    def test_deduplicate(self):
        ...
        companies = [
            ...
            Company(
                name="Test GmbH", address=Address(street="Teststraße 1", plz="2351")
            ),  # Duplikat
            Company(name="Andere AG", address=Address(street="Andere Straße 2", plz="1010")),
            Company(
                name="Test GmbH", address=Address(street="Andere Straße 3", plz="2351")
            ),  # Anderer Ort
        ]
